<tbody>
    ...
    <tr> 
        <td colspan="2">
            <span class="text-success"><?= ucwords('ShopeePay'); ?></span>
        </td>
    </tr>
    <tr> 
        <td colspan="2">
    ...
    <tr>
        <td colspan="2">
            <span class="text-success"><?= $midtrans_status['acquirer']; ?></span>
        </td>
    </tr>
    <?php if(!empty($midtrans_status['issuer'])) : ?>
    <tr> 
        <td colspan="2">
            <b>Issuer</b>
        </td>
    ...
    <tr>
        <td colspan="2">
            <span class="text-success"><?= $midtrans_status['issuer']; ?></span>
        </td>
    </tr>
    <?php endif; ?>
    <tr> 
