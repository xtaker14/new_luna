...
<div class="modal-body"> 
    <h4 class="text-success">
        <?php 
            ...
            $midtrans_renew['status_text'] = 'cancelled';
            $midtrans_renew['status_class_color'] = 'text-danger';
            if($midtrans_status['fraud_status'] == 'deny'){
                $midtrans_renew['status_text'] = 'Denied By FDS';
                $midtrans_renew['status_class_color'] = 'text-danger';
            }
        ?>
        <?= $midtrans_renew['donate_title']; ?>
    </h4>
    <table class="table table-striped" style="margin-top: 15px;">
        <?php dump($midtrans_status); ?>
