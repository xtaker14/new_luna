    ...
    ?> 
        <div class="col-sm-4 mb-2">
          ...
          <a href="<?= base_url('news/'.$val['url']); ?>">
            <!-- <img class="mini-notice rounded-circle" src="'.CDN_IMG.'assets/frontpage/img/notice/news-thumb.png" alt="" style="margin:auto;"> -->
        ...
        <?php if($cntr_news % 3 === 0): ?>
          <!-- <hr style="border:1px dashed #61551E;width:100%;max-width:100%;background-color:transparent;"> -->
        <?php endif; ?>
