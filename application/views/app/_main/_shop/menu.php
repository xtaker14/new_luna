    ...
    <ul class="category-menu">
        ...
        ?>
            ...
            <li class="cat_icon pointer <?= $im_cat_counter === 1 ? 'active' : ''; ?>" data-id="<?= $key['id']; ?>" data-category="<?= $key['categoryname']; ?>">
                ...
                <div class="category-image cat<?= $im_cat_counter; ?>" style="border: 2px solid #807f7f;border-radius: 3px;background-color: transparent;box-shadow: 0 2px 15px 1px rgba(14, 43, 69, 0.75);">
